...
class Portfolio_For_Elementor_Widget extends Widget_Base {
	...
	protected function register_controls() {
        ...
        $this->add_control(
			'grid_image_height',
			[
				'label'      => esc_html__( 'Image Height (px)', 'portfolio-for-elementor' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
				...
				'selectors'  => [
					'{{WRAPPER}} .box-height img' => 'height: {{SIZE}}{{UNIT}};',
				],
				'condition'  => [
					'portfolio_grid_style' => 'grid'
				]
        ...
        $this->add_control(
			'grid_image_width',
			[
				'label'      => esc_html__( 'Image Width (px)', 'portfolio-for-elementor' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
				...
				'selectors'  => [
					'{{WRAPPER}} .box-height img' => 'max-width: {{SIZE}}{{UNIT}};',
				],
				'condition'  => [
					'portfolio_grid_style' => 'grid'
				]
